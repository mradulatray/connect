...
class StartMeetingsController extends GetxController {
  ...
  Future<void> startMeeting(String spaceId) async {
    try {
      ...
      // Construct API URL
      final url =
          Uri.parse('${ApiUrls.baseUrl}/connect/v1/api/space/start/$spaceId');
      log('PATCH URL: $url');
      log('Token: $token');
      ...
      error.value = 'Failed to start meeting: $e';
      Get.snackbar(
        'Error',
        error.value,
        backgroundColor: Colors.redAccent,
